<?php
/**
 * Title: Two Column Info Section
 * Slug: aura/two-column
 * Categories: text, columns
 * Keywords: two column, services, about us
 * Viewport Width: 1200
 */
?>
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"4rem","bottom":"4rem","left":"1rem","right":"1rem"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull" style="padding-top:4rem;padding-bottom:4rem;padding-left:1rem;padding-right:1rem">
  ...
  <div class="wp-block-columns alignwide">
    ...
    <div class="wp-block-column">
      <!-- wp:heading {"level":2} -->
      <h2>Empower Your WordPress Workflow</h2>
      <!-- /wp:heading -->
